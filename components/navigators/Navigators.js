...
import Create from "../ProfileViews/CameraAndMaps/Create";
import {NavigationContainer} from "@react-navigation/native";
import Ionicons from "react-native-vector-icons/Ionicons";
import {StyleSheet} from "react-native"
import Details from "../ProfileViews/CameraAndMaps/Details";
...
const StackNavigation = () => {
    return (
        <Stack.Navigator style={styles.root} options={{headerShown:null}}>
            <Stack.Screen name={'Event'} component={EntranceScreen} options={{headerShown:null}}/>
